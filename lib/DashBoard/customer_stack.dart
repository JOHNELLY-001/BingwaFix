    ...
    switch (index) {
      case 0: //Dashboard
        Navigator.push(
          context,
          PageRouteBuilder(
            pageBuilder: (context, animation1, animation2) => const CustomerHomePage(),
          ),
        );
        break;
      case 1: //My request
        Navigator.push(
          context,
          PageRouteBuilder(
            pageBuilder: (context, animation1, animation2) => const MyRequestsPage(),
            settings: RouteSettings(arguments: {"id": user?['id']}), // pass userId
          ),
        );
        break;
      case 2: //NOtifications
        Navigator.push(
          context,
          PageRouteBuilder(
            pageBuilder: (context, animation1, animation2) => const CustomerNotifyPage(),
          ),
        );
        break;
      case 3: //settings
